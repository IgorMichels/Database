...
-- Last modification date: 2020-09-26 19:29:38.891
...
CREATE TABLE Aircrafts (
    ...
    Companys_id BIGINT UNSIGNED NOT NULL,
    Aircraft_Models_id BIGINT UNSIGNED NOT NULL,
    Engine_Types_id BIGINT UNSIGNED NOT NULL,
    Aircraft_Types_id BIGINT UNSIGNED NOT NULL,
    year int NOT NULL,
...
CREATE TABLE Flights (
    ...
    Aircrafts_id varchar(6) NOT NULL,
    Route_id BIGINT UNSIGNED NOT NULL,
    Date date NOT NULL,
    Arrival_time time NOT NULL,
    Departure_time time NOT NULL,
    Delay_time timestamp NOT NULL,
    Delay_Causes_id BIGINT UNSIGNED NOT NULL,
